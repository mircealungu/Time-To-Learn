...
define(['battery', 'userData', 'time', 'weather', 'fireworks', 'clickTracker', 'background', 'effects', 'settings', 'menu'], function(battery, userData, time, weather, fireworks, clickTracker, background, effects, settings, menu) {
